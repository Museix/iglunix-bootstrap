...
CFLAGS="$CFLAGS --target=$TARGET" ./configure --prefix=/usr --disable-wrapper --target=$TARGET LIBCC=$SYSROOT/usr/lib/clang/$LLVM_VER/lib/linux/libclang_rt.builtins-$ARCH.a
